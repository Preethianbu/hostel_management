...
const BookRoom = () => {
    ...
    const [foodOption, setFoodOption] = useState('without_food');
    ...
    const handleBooking = async (e) => {
        e.preventDefault();
        const totalFees = foodOption === 'with_food' ? feesPerMonth + 1000 : feesPerMonth;
                ...
                <div className="food-status">
                    <label>
                        <input
                            ...
                            name="foodOption"
                            value="without_food"
                            checked={foodOption === 'without_food'}
                            onChange={() => setFoodOption('without_food')}
                        />
                        Without Food
                    </label>
                    <label>
                        <input
                            ...
                            name="foodOption"
                            value="with_food"
                            checked={foodOption === 'with_food'}
                            onChange={() => setFoodOption('with_food')}
                        />
                        With Food (+1000)
                    </label>
                </div>
